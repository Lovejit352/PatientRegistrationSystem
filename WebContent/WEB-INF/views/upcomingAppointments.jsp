...
<body>
	...
	<div class="tableDiv">
		<p class="adminP1">Upcoming Appointments</p>
	...
	<div class="btn-container">
		<a class="link-user grow" href="${ pageContext.request.contextPath }/upcomingAppointments/addAppointment">Add Appointment</a>&nbsp;&nbsp;
		<a class="link-user grow" href="allAppointments">View All Appointments</a>
	</div>
