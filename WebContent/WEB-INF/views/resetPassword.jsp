...
<body>
	...
	<div class="usercontainer fade-in one" id="containerProperties">
		...
		<% } %>
		<a href="${ pageContext.request.contextPath }/user/updateUser/${ id }"><img class="cancelImg growImg" src="${ pageContext.request.contextPath }/resources/images/cancel.png"></a>
		<form method="post">
