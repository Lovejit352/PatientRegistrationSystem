...
<body>
	...
	<div class="fade-in one">
		<div class="usercontainer" id="containerProperties">
			...
			<% } %>
			<a href="${ pageContext.request.contextPath }/user"><img class="cancelImg growImg" src="${ pageContext.request.contextPath }/resources/images/cancel.png"></a>
			<form method="post">
		...
		<div class="btn-container">
			<a class="link-user grow" href="${ pageContext.request.contextPath }/user/updateUser/resetPassword/${ id }">Reset Password</a>
		</div>
	</div>
</body>
</html>