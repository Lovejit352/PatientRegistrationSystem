...
<body>
	...
	<div class="usercontainer" id="containerProperties">
		...
		<% } %>
		<a href="${ pageContext.request.contextPath }/upcomingAppointments"><img class="cancelImg" src="../resources/images/cancel.png"></a>
		<form method="post">
			<div class="user-input">
				<label>Enter Patient's Firstname: </label>
				<input type="text" name="patientfirstname" required autofocus>
			</div>
			<div class="user-input">
