...
<body>
	...
	<div class="btn-container">
		<a class="link-user" href="${ pageContext.request.contextPath }/upcomingAppointments/addAppointment">Add Appointment</a>
		<a class="link-user" href="allAppointments">View All Appointments</a>
	</div>
